...
const createItemInCart = (product) => {
  ...
  <div class="">
  <img src="${product.image}" class="item-in-cart-img ms-3" alt="">
  <div class="border border-primary p-3 overflow-hidden">
    <div class="text-end ">
    ...
    <p class="mb-0t text-truncate mb-2">${product.title}</p>
    <div class="d-flex justify-content-between align-items-end">
      <p class="text-black-50 mb-0">$ <span class="item-in-cart-cost fs-5">${product.price}</span></p>
...
const createProduct = (product) => {
  ...
  productDiv.innerHTML = `<div class="product-item">
    ...
    <div class="border border-primary p-3">
      ...
      <button class="btn btn-outline-primary d-block w-100 add-to-cart-btn">Add to Cart</button>
    </div>
</div>`;
  ...
  addToCartBtn.addEventListener(
    "click",
    addToCart.bind(null, product.id, addToCartBtn)
  );

  return productDiv;
};

const productRender = (productRender) => {
